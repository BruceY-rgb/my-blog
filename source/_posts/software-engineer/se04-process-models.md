...
!!! note "思考问题"
- 如果规范性过程模型追求结构和秩序，那么它们是否不适合一个依赖变化的软件世界？
...
增量 #1: 核心产品
[通信] → [规划] → [建模] → [构建] → [部署] → 交付第1个增量

增量 #2: 更多功能
[通信] → [规划] → [建模] → [构建] → [部署] → 交付第2个增量

增量 #n: 完整功能
[通信] → [规划] → [建模] → [构建] → [部署] → 交付第n个增量
```
...
!!! example "PSP vs TSP"
    - **PSP**: 关注个人能力提升，强调个人过程纪律
    - **TSP**: 关注团队协作，强调团队过程管理和持续改进
!!!
