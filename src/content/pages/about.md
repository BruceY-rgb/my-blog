...
<div class="term-container" role="region" aria-label="BruceY 的个人介绍">
  <div class="term-header">
    ...
    <div class="term-title">brucey@personal:~</div>
  </div>
  ...
  <div class="term-body">
    <div class="term-welcome">
      <div class="term-line">
        ...
        <span class="term-command">whoami</span>
      </div>
      <div class="term-output">
        <div class="avatar-section">
          <img src="/my-blog/img/AI.jpg" alt="BruceY 的插画头像" class="term-avatar" decoding="async">
    ...
    <div class="term-section">
      <div class="term-line">
        <span class="term-prompt">$</span>
        <span class="term-command">ls ~/skills/</span>
      </div>
      <div class="term-output">
    ...
    <div class="term-section">
      <div class="term-line">
        <span class="term-prompt">$</span>
        <span class="term-command">cat ~/experience.json</span>
      </div>
      <div class="term-output">
        <div class="timeline">
          <div class="timeline-item">
            ...
            <div class="timeline-content">
              <div class="timeline-date">2025 - 至今</div>
              <div class="timeline-title">全栈工程师，多智能体架构师</div>
              <div class="timeline-company">杭州零码软件</div>
              <div class="timeline-desc">负责公司核心产品研发，技术团队管理</div>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="term-section">
      <div class="term-line">
        <span class="term-prompt">$</span>
        <span class="term-command">ls ~/projects/</span>
      </div>
      <div class="term-output">
    ...
    <div class="term-section">
      <div class="term-line">
        <span class="term-prompt">$</span>
        <span class="term-command">echo $SOCIAL_LINKS</span>
      </div>
      <div class="term-output">
