...
description: >-
  Tool Dispatch Map [工具分配图] - The dispatch Map :一个 tool names 和 handler
  functions 之间的字典映射 - bash : - incoming : { name: "bash", input: { cmd: "ls -la"
  } } - 执行 sh
published: true
legacyPath: 2026/05/18/claudecode/ToolUse
sourcePath: claudecode/ToolUse.md
---

### Tool Dispatch Map

![工具分配图](/my-blog/2026/05/18/claudecode/ToolUse/image-5.png)
