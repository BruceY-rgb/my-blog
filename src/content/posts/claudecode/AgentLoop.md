...
categories:
  ...
  - 工具与执行
cover: >-
  https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSCngfu1iuZbDAg4uR55SBTsD1XF7nL0ezUrQ&s
description: >-
  最小的 agent 内核起始就是 while loop + one tool Agent While Loop的架构图 - while 循环的条件：
  while(stop reason === "tool use") [agent while-loop的架构图] 1. user input
  :当用户发送消息时，循环开始
published: true
legacyPath: 2026/05/16/claudecode/AgentLoop
sourcePath: claudecode/AgentLoop.md
---
...
![agent while-loop的架构图](/my-blog/2026/05/16/claudecode/AgentLoop/image-2.png)
...
![Loop Again](/my-blog/2026/05/16/claudecode/AgentLoop/image-3.png)
...
![执行流程](/my-blog/2026/05/16/claudecode/AgentLoop/image-4.png)
