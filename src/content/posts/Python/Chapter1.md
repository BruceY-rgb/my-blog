...
description: >-
  Python语言概述 目录 1. [计算的本质与思维] 2. [数据表示] 3. [计算模型与硬件核心] 4. [智能时代的计算范式] 5.
  [编程语言分类与翻译方式] 6. [Python语言简介] 7. [Python编程环境配置] 8. [Python基础编程] 9. [本章总结] ---
  1. 计算的本质与思维
published: true
legacyPath: 2026/03/07/Python/Chapter1
sourcePath: Python/Chapter1.md
---
...
![alt text](/my-blog/2026/03/07/Python/Chapter1/image.png)
