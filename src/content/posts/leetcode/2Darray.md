...
description: >-
  1. 顺/逆时针旋转矩阵 对于二维数组进行旋转是常见的笔试题，力扣第48题[旋转图像]就是一个很常见的题目
  题目本身是很好理解的，就是把一个二维矩阵顺时针旋转90度，难点在于要 原地修改
  但是实际上，这道题目不能走寻常路。在讲解比较巧妙的做法之前，我们先看一个谷歌考过的算法题：给定一个包含若干单词和空格的字符串 s ，
published: true
legacyPath: 2026/08/21/leetcode/2Darray
sourcePath: leetcode/2Darray.md
---
...
![转置矩阵](/my-blog/2026/08/21/leetcode/2Darray/image-6.png)

2. 反转矩阵

![反转矩阵](/my-blog/2026/08/21/leetcode/2Darray/image-7.png)

3. 可以发现最终的结果就是`matrix`顺时针旋转90度的结果

![得到旋转90度](/my-blog/2026/08/21/leetcode/2Darray/image-8.png)
