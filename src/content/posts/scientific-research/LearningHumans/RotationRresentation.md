...
tags:
  ...
  - SMPL
cover: >-
  https://n.sinaimg.cn/collect/transform/116/w550h366/20180419/WjtT-fzihnep9784217.jpg
description: >-
  Rotation Representation 旋转是人体动作(和姿态)表示中非常重要的基础。这一部分将简短介绍旋转表示和一些相关的概念 1. 什么是旋转
  在3D空间中，描述一个物体如何旋转有不同的方法。每种方法都有其优缺点，在不同场景下使用 2. 欧拉角(Euler Angles) 定义 欧拉角用是三个
  旋转角度 来
published: true
legacyPath: 2026/04/05/scientific-research/LearningHumans/RotationRresentation
sourcePath: scientific-research/LearningHumans/RotationRresentation.md
---
...
![alt text](/my-blog/2026/04/05/scientific-research/LearningHumans/RotationRresentation/image.png)
