...
description: >-
  这是一个虚拟人类（Virtual Human）工具和代码示例的学习项目，专注于人体参数化模型（SMPL系列）。以下是该项目的学习路径规划： --- 项目定位
  这是一个人体运动研究的入门教程，涵盖从基础数学（3D旋转表示）到高级参数化人体模型（SMPL/SMPL-X）的完整知识体系。项目重度依赖 ez4d 库。
  项目仓库
published: true
legacyPath: 2026/03/08/scientific-research/LearningHumans/index
sourcePath: scientific-research/LearningHumans/index.md
---
