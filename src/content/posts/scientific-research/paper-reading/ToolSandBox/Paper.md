...
description: >-
  0. Abstract 先前的工作要么聚焦于无状态的 Web 服务上评测，基于 单轮用户提示 要么基于离线策略对话轨迹评测 ToolSandBox
  则包含了有状态的工具执行、工具之间的隐式状态依赖、一个支持在线策略对话评测的内置用户模拟器，以及一种针对任意轨迹中的中间里程碑和最终里程碑的动态评测策略
  三大困难场景： -
categories:
  - 科研训练
  - Agent
  - 论文阅读
published: true
legacyPath: 2026/08/04/scientific-research/paper-reading/ToolSandBox/Paper
sourcePath: scientific-research/paper-reading/ToolSandBox/Paper.md
---
...
![Comparison](/my-blog/2026/08/04/scientific-research/paper-reading/ToolSandBox/Paper/image.png)

![一个evaluation trajectory的例子](/my-blog/2026/08/04/scientific-research/paper-reading/ToolSandBox/Paper/image-1.png)

## 2. ToolSandBox Design

![ToolSandBox的交互设计架构](/my-blog/2026/08/04/scientific-research/paper-reading/ToolSandBox/Paper/image-2.png)
...
![消融实验，用于验证提示词新增因素的有效性](/my-blog/2026/08/04/scientific-research/paper-reading/ToolSandBox/Paper/image-3.png)

我们还要验证一下：**模拟器误差是否因为Agent模型不同而变化**

![不同模型的模拟器系统偏差](/my-blog/2026/08/04/scientific-research/paper-reading/ToolSandBox/Paper/image-4.png)

三个不同Agent的模拟器总误差在`7.78%~8.07%`之间，方差很小。这说明模拟器误差是一个 **系统性的常数偏置，不会让某一个Agent特别占便宜或者吃亏**

![Message Bus的示例以及不同角色的子视图](/my-blog/2026/08/04/scientific-research/paper-reading/ToolSandBox/Paper/image-5.png)
...
![传统评估方式的困境](/my-blog/2026/08/04/scientific-research/paper-reading/ToolSandBox/Paper/image-6.png)
