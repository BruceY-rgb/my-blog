...
tags:
  ...
  - 机器学习
description: >-
  Deep Learning Basics 讲师：汤斯亮（Siliang Tang） Email: siliang@zju.edu.cn --- 1.
  Machine Learning ≈ Looking for a Function 机器学习的本质是寻找一个函数（Function），可以应用于多种场景：
  - 语音识别（
published: true
legacyPath: 2026/03/10/nlp/deep-learning-basics
sourcePath: nlp/deep-learning-basics.md
---
...
![alt text](/my-blog/2026/03/10/nlp/deep-learning-basics/image-3.png)

- **图像识别（Image Recognition）**
  输入：图片 → 输出："Cat"

![alt text](/my-blog/2026/03/10/nlp/deep-learning-basics/image-4.png)

- **围棋对弈（Playing Go）**
  输入：棋盘状态 → 输出："5-5"（下一步）

![alt text](/my-blog/2026/03/10/nlp/deep-learning-basics/image-5.png)

- **对话系统（Dialogue System）**
  输入："Hi"（用户说的话） → 输出："Hello"（系统回复）

![alt text](/my-blog/2026/03/10/nlp/deep-learning-basics/image-6.png)
...
![alt text](/my-blog/2026/03/10/nlp/deep-learning-basics/image-7.png)
![alt text](/my-blog/2026/03/10/nlp/deep-learning-basics/image-8.png)
---
...
![alt text](/my-blog/2026/03/10/nlp/deep-learning-basics/image-9.png)
...
![alt text](/my-blog/2026/03/10/nlp/deep-learning-basics/image-10.png)
...
![alt text](/my-blog/2026/03/10/nlp/deep-learning-basics/image-11.png)
...
![alt text](/my-blog/2026/03/10/nlp/deep-learning-basics/image-12.png)
...
![alt text](/my-blog/2026/03/10/nlp/deep-learning-basics/image-13.png)
...
![alt text](/my-blog/2026/03/10/nlp/deep-learning-basics/image-14.png)
...
![alt text](/my-blog/2026/03/10/nlp/deep-learning-basics/image-15.png)
---
