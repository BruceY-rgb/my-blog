...
description: >-
  实验一种我们进行了词法分析与语法分析，对于符合语法的程序，我们可以从中构建出一个语法树 然而并不是所有符合语法的程序都是合法的程序，下面的语句完全符合
  SysY 语法，但是仍然不是合法的程序，无法通过编译 这是因为它不符合 SysY
  的语义约束，初始化的左右两边类型不匹配。在本次实验中，我们将进行语义分析，即检查是否符
published: true
legacyPath: 2026/05/07/compile/lab2
sourcePath: compile/lab2.md
---
