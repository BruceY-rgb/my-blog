...
description: >-
  编译原理 Chapter 3：语法分析-CFG及其解析 目录 1. [语法分析概述] 2. [上下文无关文法] 3. [设计编程语言的文法] 4.
  [自顶向下分析] 5. [自底向上分析] 6. [LR(1) 分析] 7. [LALR(1) 分析] 8. [Parser Generator] 9.
  [语法分析小结] 1
published: true
legacyPath: 2026/03/14/compile/Chapter3
sourcePath: compile/Chapter3.md
---
...
5. [自底向上分析](#5-自底向上分析)
6. [LR(1) 分析](#6-lr1-分析)
7. [LALR(1) 分析](#7-lalr1-分析)
8. [Parser Generator](#8-parser-generator)
9. [语法分析小结](#9-语法分析小结)
10. [错误恢复（补充）](#10-错误恢复补充）
...
![alt text](/my-blog/2026/03/14/compile/Chapter3/image-58.png)
</aside>
### 1.2 回顾：语法分析器的作用
...
![alt text](/my-blog/2026/03/14/compile/Chapter3/image-59.png)
...
![alt text](/my-blog/2026/03/14/compile/Chapter3/image-60.png)
</aside>
### 1.4 语法分析器的实现方式
...
![alt text](/my-blog/2026/03/14/compile/Chapter3/image-61.png)
...
![alt text](/my-blog/2026/03/14/compile/Chapter3/image-62.png)
<aside class="admonition ---">
## 4. 分析树 (Parse Tree)
...
![alt text](/my-blog/2026/03/14/compile/Chapter3/image-63.png)
</aside>
### 4.2 练习：Parse Tree 构造

!!! example Parse Tree 构造练习

![alt text](/my-blog/2026/03/14/compile/Chapter3/image-64.png)
...
![alt text](/my-blog/2026/03/14/compile/Chapter3/image-65.png)
...
![alt text](/my-blog/2026/03/14/compile/Chapter3/image-66.png)
...
![alt text](/my-blog/2026/03/14/compile/Chapter3/image-67.png)
...
![alt text](/my-blog/2026/03/14/compile/Chapter3/image-68.png)
...
![alt text](/my-blog/2026/03/14/compile/Chapter3/image-69.png)
</aside>
### 6.6 消除二义性

二义性的根源：多种"正确"推导处于文法同一层，没有区分优先级和结合性。

![alt text](/my-blog/2026/03/14/compile/Chapter3/image-70.png)
...
![alt text](/my-blog/2026/03/14/compile/Chapter3/image-71.png)

**消除方法**：区分 matched 和 unmatched then

![alt text](/my-blog/2026/03/14/compile/Chapter3/image-72.png)
...
![alt text](/my-blog/2026/03/14/compile/Chapter3/image-73.png)
...
![alt text](/my-blog/2026/03/14/compile/Chapter3/image-74.png)
...
![alt text](/my-blog/2026/03/14/compile/Chapter3/image-75.png)
...
![alt text](/my-blog/2026/03/14/compile/Chapter3/image-76.png)

Follow集的归纳定义是一般情况，对于一些特殊的产生式，可能可以运用简单的推论，比如

![alt text](/my-blog/2026/03/14/compile/Chapter3/image-77.png)

![alt text](/my-blog/2026/03/14/compile/Chapter3/image-78.png)
...
![alt text](/my-blog/2026/03/14/compile/Chapter3/image-79.png)

2. 由于$Y → ε$，所以$Nullable \cup = {Y}$

![alt text](/my-blog/2026/03/14/compile/Chapter3/image-80.png)

3. 由于$X → Y$，所以$Nullable \cup = {X}$(Inductive case)

![alt text](/my-blog/2026/03/14/compile/Chapter3/image-81.png)

4. 由$Z → XYZ$确认，这里我们要停止迭代

![alt text](/my-blog/2026/03/14/compile/Chapter3/image-82.png)

**First集**

1. 初始化First集

![alt text](/my-blog/2026/03/14/compile/Chapter3/image-83.png)

2. 找到所有Base case

![alt text](/my-blog/2026/03/14/compile/Chapter3/image-84.png)

3. 考虑Inductive case,也就是所有产生式右侧出现非终结符的情况

![alt text](/my-blog/2026/03/14/compile/Chapter3/image-85.png)
![alt text](/my-blog/2026/03/14/compile/Chapter3/image-86.png)
...
![alt text](/my-blog/2026/03/14/compile/Chapter3/image-87.png)

2. Indective Case的两种情况

![alt text](/my-blog/2026/03/14/compile/Chapter3/image-88.png)
![alt text](/my-blog/2026/03/14/compile/Chapter3/image-89.png)
...
2. **若 $β ⇒^* ε$，则 $α ⇒^* ε$，且 First(α) ∩ Follow(A) = ∅**
    ...
    **场景推演**
    ![alt text](/my-blog/2026/03/14/compile/Chapter3/image-90.png)
...
![alt text](/my-blog/2026/03/14/compile/Chapter3/image-91.png)
...
文法：
![alt text](/my-blog/2026/03/14/compile/Chapter3/image-92.png)

Nullable,First,Follow Set

![alt text](/my-blog/2026/03/14/compile/Chapter3/image-93.png)

![alt text](/my-blog/2026/03/14/compile/Chapter3/image-94.png)
![alt text](/my-blog/2026/03/14/compile/Chapter3/image-95.png)
![alt text](/my-blog/2026/03/14/compile/Chapter3/image-96.png)
![alt text](/my-blog/2026/03/14/compile/Chapter3/image-97.png)
...
![alt text](/my-blog/2026/03/14/compile/Chapter3/image-98.png)
...
![alt text](/my-blog/2026/03/14/compile/Chapter3/image-99.png)
...
![alt text](/my-blog/2026/03/14/compile/Chapter3/image-100.png)
...
![alt text](/my-blog/2026/03/14/compile/Chapter3/image-101.png)
</aside>
- 完整版`LR`分析：最右推导的逆过程
  - **限制了归约方式**(类似LL中的最左推导)
- **最右句型**：最右推导过程中出现的句型
...
![alt text](/my-blog/2026/03/14/compile/Chapter3/image-102.png)
...
![LR分析器的整体结构](/my-blog/2026/03/14/compile/Chapter3/image-103.png)
...
![alt text](/my-blog/2026/03/14/compile/Chapter3/image-104.png) 
...
![alt text](/my-blog/2026/03/14/compile/Chapter3/image-105.png)
...
!!! example "S→bBB"
![alt text](/my-blog/2026/03/14/compile/Chapter3/image-106.png)
</aside>
...
![alt text](/my-blog/2026/03/14/compile/Chapter3/image-107.png)
...
- 状态迁移关系
  ...
  ![alt text](/my-blog/2026/03/14/compile/Chapter3/image-108.png)
  2. 如果存在产生式$X \rightarrow \alpha Y \beta$以及$Y \rightarrow \gamma$那么$X → αY•\beta$可以转换成$Y → •\gamma$
  ![alt text](/my-blog/2026/03/14/compile/Chapter3/image-109.png) 

> 简单解释一下2：如果我们想进一步移进，必须要先展开`Y`，看看`Y`具体能推导出什么

![alt text](/my-blog/2026/03/14/compile/Chapter3/image-110.png)

#### 5.2.4 LR(0)分析DFA

![alt text](/my-blog/2026/03/14/compile/Chapter3/image-112.png)

!!! question "如何跳过NFA直接构造以下DFA"
![alt text](/my-blog/2026/03/14/compile/Chapter3/image-113.png)
</aside>
**项集闭包** (Closure)：
...
![alt text](/my-blog/2026/03/14/compile/Chapter3/image-114.png)
...
![alt text](/my-blog/2026/03/14/compile/Chapter3/image-115.png)
...
![alt text](/my-blog/2026/03/14/compile/Chapter3/image-116.png)
...
<aside class="admonition example">
![alt text](/my-blog/2026/03/14/compile/Chapter3/image-117.png)
</aside>
#### 5.2.5 LR(0) 分析表构造
...
![alt text](/my-blog/2026/03/14/compile/Chapter3/image-120.png)

![alt text](/my-blog/2026/03/14/compile/Chapter3/image-118.png)
![alt text](/my-blog/2026/03/14/compile/Chapter3/image-119.png)
...
<aside class="admonition example">
![alt text](/my-blog/2026/03/14/compile/Chapter3/image-121.png)
</aside>
#### 5.2.4 LR(0) 分析算法
...
![alt text](/my-blog/2026/03/14/compile/Chapter3/image-122.png)
...
![alt text](/my-blog/2026/03/14/compile/Chapter3/image-124.png)

因此，每步归约都应该满足$t \in Follow(E)$

- E是用来归约的产生式的左部
- t是Next Token(Lookahead)

![alt text](/my-blog/2026/03/14/compile/Chapter3/image-125.png)
...
![alt text](/my-blog/2026/03/14/compile/Chapter3/image-123.png)
...
![alt text](/my-blog/2026/03/14/compile/Chapter3/image-126.png)

<aside class="admonition example">
![alt text](/my-blog/2026/03/14/compile/Chapter3/image-127.png)
</aside>
- SLR技术解决冲突的方法
    - 按照$A \rightarrow \alpha$进行归约的条件是：下一个输入符号x可以在**某个句型**中跟在A之后，也就是$x \in Follow(A)$
- LR分析过程应该是最右推倒的逆
    - 每一步都应该是最右句型
    - 如果$\beta A x$不是以任何最右句型的前缀，那么即使x在某个句型中跟在A之后，仍然不应该按照$A \rightarrow \alpha$进行归约

> 利用Follow集可以看做是合理但是可能不够精确的近似
...
![LR解析器的能力范围](/my-blog/2026/03/14/compile/Chapter3/image-144.png)
...
![可以合并的状态举例](/my-blog/2026/03/14/compile/Chapter3/image-145.png)
...
![可以合并的状态](/my-blog/2026/03/14/compile/Chapter3/image-146.png)
...
![LR(1)有相同核心的不同状态](/my-blog/2026/03/14/compile/Chapter3/image-147.png)
...
![BE可以合并的例子](/my-blog/2026/03/14/compile/Chapter3/image-148.png) 
...
<aside class="admonition example">
![LR(1) to LALR(1) DFA](/my-blog/2026/03/14/compile/Chapter3/image-149.png)
![解析表转化](/my-blog/2026/03/14/compile/Chapter3/image-150.png)
</aside>
- LR(1)
...
![Yacc](/my-blog/2026/03/14/compile/Chapter3/image-151.png)
...
![Lax和Yacc](/my-blog/2026/03/14/compile/Chapter3/image-152.png)
...
![LL和LR对比](/my-blog/2026/03/14/compile/Chapter3/image-153.png)

- `LL(1)`:向前看下一个输入根据`First`,`Follow`确定使用哪条产生式推导
- `LR(1)`:在识别出整个 $\alpha$后，再往前看一个符号，然后确定使用哪条产生式规约

![LL(1), SLR(1)和LR(1)对比](/my-blog/2026/03/14/compile/Chapter3/image-154.png)

![练习](/my-blog/2026/03/14/compile/Chapter3/image-155.png)
