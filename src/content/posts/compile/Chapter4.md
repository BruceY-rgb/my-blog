...
description: >-
  1. Semantic Actions（语义动作） - 解析器 ：识别一个句子是否属于某个文法定义的语言（通俗一点：输入是否符合规则） - 编译器
  ：必须对这个句子做更有用的事情 - 构造抽象语法树( abstract syntax tree )：把程序组织成树形结构，表示运算层次和语法结构 -
  执行语义分析( sem
published: true
legacyPath: 2026/04/16/compile/Chapter4
sourcePath: compile/Chapter4.md
---
...
![语法分析流程](/my-blog/2026/04/16/compile/Chapter4/image-156.png)

### 1.1 Recursive Descent

给定文法：

![给定文法](/my-blog/2026/04/16/compile/Chapter4/image-157.png)
...
![代码构建的简单流程图](/my-blog/2026/04/16/compile/Chapter4/image-158.png)
...
![原理示意图](/my-blog/2026/04/16/compile/Chapter4/image-159.png)
![实例](/my-blog/2026/04/16/compile/Chapter4/image-160.png)
...
![具体语法树](/my-blog/2026/04/16/compile/Chapter4/image-161.png)
...
![构造抽象语法的过程](/my-blog/2026/04/16/compile/Chapter4/image-162.png)
...
![抽象语法结构](/my-blog/2026/04/16/compile/Chapter4/image-163.png)
</aside>
#### 自动构建抽象语法树
...
<aside class="admonition example">
![局部错误恢复的例子](/my-blog/2026/04/16/compile/Chapter4/image-164.png)
</aside>
...
![全局错误恢复例子](/my-blog/2026/04/16/compile/Chapter4/image-165.png)
...
![示意图](/my-blog/2026/04/16/compile/Chapter4/image-166.png)
