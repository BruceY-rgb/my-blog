...
description: >-
  - Automatic Memory Management :内存回收( Reclamation )时自动完成的 - Garbage
  ：已经被分配，但是不再被使用的存储空间 [如果不进行垃圾回收会出现的悬空指针的问题] 1. Garbage Collection 1.1 What -
  Garbage Collectio
published: true
legacyPath: 2026/06/08/compile/Chapter13
sourcePath: compile/Chapter13.md
---

- **Automatic Memory Management**:内存回收(`Reclamation`)时自动完成的
- **Garbage**：已经被分配，但是不再被使用的存储空间

![如果不进行垃圾回收会出现的悬空指针的问题](/my-blog/2026/06/08/compile/Chapter13/image-266.png)
...
![有向图示意图](/my-blog/2026/06/08/compile/Chapter13/image-267.png)
...
![一个垃圾回收的示例](/my-blog/2026/06/08/compile/Chapter13/image-268.png)
...
![mark](/my-blog/2026/06/08/compile/Chapter13/image-269.png)
...
![freelist](/my-blog/2026/06/08/compile/Chapter13/image-270.png)
...
![算法流程](/my-blog/2026/06/08/compile/Chapter13/image-271.png)
...
<aside class="admonition example">
![指针反转1](/my-blog/2026/06/08/compile/Chapter13/image-272.png)
![指针反转2](/my-blog/2026/06/08/compile/Chapter13/image-273.png)
![指针反转3](/my-blog/2026/06/08/compile/Chapter13/image-274.png)
![指针反转4](/my-blog/2026/06/08/compile/Chapter13/image-275.png)
![指针反转5](/my-blog/2026/06/08/compile/Chapter13/image-276.png)
![指针反转6](/my-blog/2026/06/08/compile/Chapter13/image-277.png)
</aside>
```go
function DFS(x)
...
![算法流程](/my-blog/2026/06/08/compile/Chapter13/image-278.png)
...
<aside class="admonition example">
![指针反转实例](/my-blog/2026/06/08/compile/Chapter13/image-279.png)
...
![碎片的示例](/my-blog/2026/06/08/compile/Chapter13/image-280.png)
...
<aside class="admonition example">
![引用计数1](/my-blog/2026/06/08/compile/Chapter13/image-281.png)
![引用计数2](/my-blog/2026/06/08/compile/Chapter13/image-282.png)
![引用计数3](/my-blog/2026/06/08/compile/Chapter13/image-283.png)
![引用计数4](/my-blog/2026/06/08/compile/Chapter13/image-284.png)
</aside>
...
![引用环的问题](/my-blog/2026/06/08/compile/Chapter13/image-285.png)
</aside>
...
![copying collection](/my-blog/2026/06/08/compile/Chapter13/image-286.png)
...
![forwarding pointer找新纪录的位置](/my-blog/2026/06/08/compile/Chapter13/image-287.png)
...
![一个广度优先的复制式垃圾回收](/my-blog/2026/06/08/compile/Chapter13/image-288.png)
...
![Cheney复制算法的核心循环](/my-blog/2026/06/08/compile/Chapter13/image-289.png)
