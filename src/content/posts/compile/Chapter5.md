...
description: >-
  上下文无关文法CFG的局限性 - 考虑下面这个文法 - 程序由 声明+语句 组成 - 声明里面可以写 - string x - int z -
  语句内部可以赋值 - id = exp - 表达式里面可以写 - exp + exp - id - num 从纯语法角度来看下面这个程序 parser
  很可能会接受这个程序的结
published: true
legacyPath: 2026/05/05/compile/Chapter5
sourcePath: compile/Chapter5.md
---
...
![Java符号表结构](/my-blog/2026/05/05/compile/Chapter5/image-167.png)
...
![ML符号表分析](/my-blog/2026/05/05/compile/Chapter5/image-168.png)
...
![命令式符号表](/my-blog/2026/05/05/compile/Chapter5/image-169.png)
...
![哈希表结构示意图](/my-blog/2026/05/05/compile/Chapter5/image-171.png)
...
![插入操作的实例](/my-blog/2026/05/05/compile/Chapter5/image-170.png)
...
![lookup操作的流程图](/my-blog/2026/05/05/compile/Chapter5/image-173.png)
...
![pop操作实例](/my-blog/2026/05/05/compile/Chapter5/image-172.png)
...
![m1被修改](/my-blog/2026/05/05/compile/Chapter5/image-174.png)
...
![数组方案](/my-blog/2026/05/05/compile/Chapter5/image-175.png)
...
![函数式风格采用路径复制的例子](/my-blog/2026/05/05/compile/Chapter5/image-176.png)
...
<aside class="admonition example">
![作用域进入与退出的例子](/my-blog/2026/05/05/compile/Chapter5/image-177.png)
</aside>
!!! question "如何精确弹出那些绑定"
...
<aside class="admonition example">
![辅助栈的操作流程](/my-blog/2026/05/05/compile/Chapter5/image-178.png)
</aside>
## 5.3 Type Checking
...
![tiger语法实例](/my-blog/2026/05/05/compile/Chapter5/image-179.png)
...
![不同绑定属于命名空间的例子](/my-blog/2026/05/05/compile/Chapter5/image-180.png)
