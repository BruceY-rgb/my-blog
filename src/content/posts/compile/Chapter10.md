...
description: >-
  10.1 Liveness Analysis 10.1.1 Why, How, What 1. Why [整个编译的流程] 问题 - 中间表示 IR
  ：可以使用无限多个临时变量 - 真实机器中只有有限数量的寄存器可以使用 如果临时变量 a 和 b 从来不会再同一时间被使用，那么它们 可以放进同一个寄存器
  因此，很多临时
published: true
legacyPath: 2026/05/31/compile/Chapter10
sourcePath: compile/Chapter10.md
---
...
![整个编译的流程](/my-blog/2026/05/31/compile/Chapter10/image-228.png)
...
![控制流图](/my-blog/2026/05/31/compile/Chapter10/image-229.png)
...
![a,b,c三个变量的活跃情况](/my-blog/2026/05/31/compile/Chapter10/image-230.png)
...
![控制流属于介绍](/my-blog/2026/05/31/compile/Chapter10/image-231.png)
...
![规则一](/my-blog/2026/05/31/compile/Chapter10/image-232.png)
...
![控制流图](/my-blog/2026/05/31/compile/Chapter10/image-233.png)
...
![两个核心公式](/my-blog/2026/05/31/compile/Chapter10/image-234.png)
...
![整个执行流程](/my-blog/2026/05/31/compile/Chapter10/image-235.png)
...
![活跃方程构建实例](/my-blog/2026/05/31/compile/Chapter10/image-236.png)
...
!!! note "如何证明这个重要的结论"
![最小不动点证明](/my-blog/2026/05/31/compile/Chapter10/image-237.png)
</aside>
...
![冲突的表示方式](/my-blog/2026/05/31/compile/Chapter10/image-238.png)
