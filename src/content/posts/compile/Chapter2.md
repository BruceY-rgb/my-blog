...
description: >-
  编译原理 Chapter 2：词法分析 目录 1. [词法分析概述] 2. [正则表达式] 3. [有穷自动机] 4. [词法分析器自动生成] 5.
  [Lex工具] --- 1. 词法分析概述 1.1 什么是词法分析 词法分析 (Lexical Analysis) 是编译器的第一个阶段，也称为 扫描
  (Scanning
published: true
legacyPath: 2026/03/03/compile/Chapter2
sourcePath: compile/Chapter2.md
---
...
![alt text](/my-blog/2026/03/03/compile/Chapter2/image-16.png)
...
![alt text](/my-blog/2026/03/03/compile/Chapter2/image-17.png)
...
![alt text](/my-blog/2026/03/03/compile/Chapter2/image-18.png)
</aside>
### 2.6 正则定义
...
![alt text](/my-blog/2026/03/03/compile/Chapter2/image-19.png)
...
![alt text](/my-blog/2026/03/03/compile/Chapter2/image-20.png)
...
![alt text](/my-blog/2026/03/03/compile/Chapter2/image-21.png)
...
- **状态转换**：如果对于输入 a，存在从状态 p 到状态 q 的转换，就在 p、q 之间画一条有向边，并标记上 a
 ...
 ![alt text](/my-blog/2026/03/03/compile/Chapter2/image-22.png)

#### 转换表 (Transition Table)

 ![alt text](/my-blog/2026/03/03/compile/Chapter2/image-23.png)
...
<aside class="admonition example">
![alt text](/my-blog/2026/03/03/compile/Chapter2/image-24.png)
</aside>
#### 有穷自动机接收(定义的语言)
...
<aside class="admonition example">
![alt text](/my-blog/2026/03/03/compile/Chapter2/image-25.png)
![alt text](/my-blog/2026/03/03/compile/Chapter2/image-26.png)
</aside>
### 3.4 有穷自动机的分类
...
![alt text](/my-blog/2026/03/03/compile/Chapter2/image-27.png)

<aside class="admonition example">
![alt text](/my-blog/2026/03/03/compile/Chapter2/image-28.png)
</aside>
...
![alt text](/my-blog/2026/03/03/compile/Chapter2/image-29.png)
...
![alt text](/my-blog/2026/03/03/compile/Chapter2/image-30.png)
...
![alt text](/my-blog/2026/03/03/compile/Chapter2/image-31.png)
...
![alt text](/my-blog/2026/03/03/compile/Chapter2/image-32.png)
...
![alt text](/my-blog/2026/03/03/compile/Chapter2/image-33.png)
...
1. **识别 ε 的 NFA**：
![alt text](/my-blog/2026/03/03/compile/Chapter2/image-34.png)

1. **识别符号 a 的 NFA**：
![alt text](/my-blog/2026/03/03/compile/Chapter2/image-35.png)
...
1. **选择 s | t（并联）**：
![alt text](/my-blog/2026/03/03/compile/Chapter2/image-36.png)

2. **连接 st（串联）**：将 N(s) 的接受状态和 N(t) 的开始状态合并
![alt text](/my-blog/2026/03/03/compile/Chapter2/image-37.png)

3. **闭包 s***：添加从开始状态到接受状态的 ε 边，以及从接受状态回传到 N(s) 的 ε 边

![alt text](/my-blog/2026/03/03/compile/Chapter2/image-38.png)

!!! example 正则表达式 r = a(b|c)* 到 NFA

![alt text](/my-blog/2026/03/03/compile/Chapter2/image-39.png)
![alt text](/my-blog/2026/03/03/compile/Chapter2/image-40.png)
</aside>
### 4.3 NFA → DFA（子集构造法）
...
![alt text](/my-blog/2026/03/03/compile/Chapter2/image-41.png)

**Step 1**:计算ε-closure(0)

![alt text](/my-blog/2026/03/03/compile/Chapter2/image-42.png)

**Step 2**:计算ε-closure(move(A,a))

![alt text](/my-blog/2026/03/03/compile/Chapter2/image-43.png)

*更新状态转换表*

![alt text](/my-blog/2026/03/03/compile/Chapter2/image-44.png)

**Step 3**:计算ε-closure(move(A,b))

![alt text](/my-blog/2026/03/03/compile/Chapter2/image-45.png)

*更新状态转换表*

![alt text](/my-blog/2026/03/03/compile/Chapter2/image-46.png)

**Step 4**：依次向下计算...直到到达了**不动点**

![alt text](/my-blog/2026/03/03/compile/Chapter2/image-47.png)

**Step 5**:根据DFA转换表，生成DFA转换图

![alt text](/my-blog/2026/03/03/compile/Chapter2/image-48.png)
</aside>
...
![alt text](/my-blog/2026/03/03/compile/Chapter2/image-49.png)
...
<aside class="admonition example">
![alt text](/my-blog/2026/03/03/compile/Chapter2/image-50.png)
</aside>
...
<aside class="admonition example">
![alt text](/my-blog/2026/03/03/compile/Chapter2/image-51.png)
</aside>
#### DFA状态等价的条件
...
<aside class="admonition example">
![alt text](/my-blog/2026/03/03/compile/Chapter2/image-52.png)
![alt text](/my-blog/2026/03/03/compile/Chapter2/image-53.png)
![alt text](/my-blog/2026/03/03/compile/Chapter2/image-54.png)
</aside>
**构造部分**：
...
!!! example DFA 最小化示例
![alt text](/my-blog/2026/03/03/compile/Chapter2/image-55.png)
...
![alt text](/my-blog/2026/03/03/compile/Chapter2/image-56.png)
...
```
![alt text](/my-blog/2026/03/03/compile/Chapter2/image-57.png)
---
