...
tags:
  - 软件工程
description: >-
  Ch.2 Software Engineering 2.1 软件工程的定义 IEEE 定义 软件工程 是： 1. 将系统的( systematic
  )、规范的( disciplined )、可量化的( quantifable )方法应用于软件的开发、运行和维护；即工程在软件中的应用 2.
  对上述方法的研究 软件工程的三
published: true
legacyPath: 2026/03/10/software-engineer/se02-software-engineering
sourcePath: software-engineer/se02-software-engineering.md
---
...
![alt text](/my-blog/2026/03/10/software-engineer/se02-software-engineering/image-3.png)
