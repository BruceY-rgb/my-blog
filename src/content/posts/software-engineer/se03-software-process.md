...
tags:
  ...
  - 软件过程
description: >-
  Ch.3 Software Process Structure 3.1 通用过程模型 (A Generic Process Model) 软件过程框架
  软件过程是一个 框架 ，包含以下结构： [alt text] 软件过程 = 框架活动 (Framework Activities) + 伞活动
  (Umbrella Ac
published: true
legacyPath: 2026/03/10/software-engineer/se03-software-process
sourcePath: software-engineer/se03-software-process.md
---
...
![alt text](/my-blog/2026/03/10/software-engineer/se03-software-process/image-4.png)
...
![alt text](/my-blog/2026/03/10/software-engineer/se03-software-process/image-5.png)
...
![alt text](/my-blog/2026/03/10/software-engineer/se03-software-process/image-15.png)
<aside class="admonition ---">
...
![alt text](/my-blog/2026/03/10/software-engineer/se03-software-process/image-6.png)
