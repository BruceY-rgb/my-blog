...
tags:
  ...
  - 过程模型
description: >-
  Ch.4 Process Models 4.1 规范性模型 (Prescriptive Models) 规范性过程模型的定义 规范性过程模型 (
  Prescriptive process models ) 倡导一种有序的软件工程方法。 !!! question "思考问题" -
  如果规范性过程模型追求结构和秩序( st
published: true
legacyPath: 2026/03/10/software-engineer/se04-process-models
sourcePath: software-engineer/se04-process-models.md
---
...
![alt text](/my-blog/2026/03/10/software-engineer/se04-process-models/image-7.png)
...
![alt text](/my-blog/2026/03/10/software-engineer/se04-process-models/image-8.png)
...
![alt text](/my-blog/2026/03/10/software-engineer/se04-process-models/image-9.png)
...
![alt text](/my-blog/2026/03/10/software-engineer/se04-process-models/image-10.png)
...
![alt text](/my-blog/2026/03/10/software-engineer/se04-process-models/image-11.png)
...
![alt text](/my-blog/2026/03/10/software-engineer/se04-process-models/image-12.png)
...
![alt text](/my-blog/2026/03/10/software-engineer/se04-process-models/image-13.png)
...
![alt text](/my-blog/2026/03/10/software-engineer/se04-process-models/image-14.png)
