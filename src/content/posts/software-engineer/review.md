...
tags:
  - 软件工程
description: >-
  第一章 The Nature of Software 1.1 什么是软件 软件是构成一个配置的 一系列元素或者对象的集合 ，主要包括： - 指令
  (计算机程序)： Instructions ( Computer Program ) - 数据结构 - 文档 1.2 软件 VS 硬件 对比维度 软件
  (Software) 
published: true
legacyPath: 2026/06/02/software-engineer/review
sourcePath: software-engineer/review.md
---
